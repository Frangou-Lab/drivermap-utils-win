...
xmlns:wix="http://schemas.microsoft.com/wix/2006/wi">
  ...
  <xsl:key name="service-search" match="wix:Component[contains(wix:File/@Source, '.csvc')]" use="@Id" />
  <xsl:key name="service-search" match="wix:Component[contains(wix:File/@Source, '.ctp')]" use="@Id" />
